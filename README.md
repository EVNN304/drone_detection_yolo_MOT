...
⚠️ Важные примечания
    ...
    Производительность: Для достижения высокого FPS рекомендуется использовать TensorRT引擎 (.engine) для YOLO и включать half_flag=True (FP16), если ваша GPU поддерживает это.
