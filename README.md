...
Проект объединяет **YOLOv11x-26x** для детекции, **SAHI-batching** для работы с мелкими объектами, **HybridSort** для многообъектного трекинга, **STARK/NanoTrack** для точного сопровождения одиночных целей.
