...
class Yolo_inits_batch:
    def __init__(self, q_from_neuro: mp.Queue,  saved_mode=None, names_files=None, name_folder="TEST_SAVE_SERVER_", render_cfg=None, classes_names={}):
    ...
    def run_nets(self, daemon=True):
        ...
        neuro_data_collector = mp.Process(target=self.collect_n_cast_neuro, args=(self.q_from_neuro, self.saved_mode), daemon=daemon)
